...
function seleccionarServicio(servicio) {
    ...
    // Comprar si un servicio ya fue agregado 
...
function seleccionarFecha() {
    ...
    inputFecha.addEventListener('input', function(e) {
        ...
        if( [0].includes(dia) ) {
            e.target.value = '';
            mostrarAlerta('Los Domingos no se trabaja', 'error', '.formulario');
        } else {
...
function mostrarResumen() {
    ...
    // Headind para servicios en resumen
